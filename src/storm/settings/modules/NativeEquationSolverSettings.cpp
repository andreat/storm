...
const std::string NativeEquationSolverSettings::aboviPrintEstimatedErrorOptionName = "abovi-print-estimated-error";
...
bool NativeEquationSolverSettings::getABOVIPrintEstimatedError() const {
