...
class NativeLinearEquationSolver : public LinearEquationSolver<ValueType> {
   ...
   private:
    ...
    virtual bool solveEquationsAdaptiveBayesianOptimizationValueIteration(storm::Environment const& env, std::vector<ValueType>& x, std::vector<ValueType> const& b) const;
